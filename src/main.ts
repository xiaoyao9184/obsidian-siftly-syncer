// eslint-disable-next-line import-x/no-unassigned-import, import-x/no-empty-named-blocks -- Side-effect import and empty type import are required by Obsidian typings/bootstrap pattern.
